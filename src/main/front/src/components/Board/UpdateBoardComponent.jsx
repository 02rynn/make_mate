        ...
        <div className="container" style={{marginTop:'3%'}}>
          <div className="row" >
            <div className="card col-md-6 offset-md-3 offset-md-3" >
              <h3 className="text-center" style={{marginTop:'3%'}} >게시물 수정</h3>
              <div className="card-body">
                <form>
                  ...
                  <div className="form-group">
                    ...
                    <input type="text" placeholder="제목을 입력해주세용가리" name="title" className="form-control"
                            value={inputTitle} onChange={changeTitleHandler} />
                  </div>
                  <div className="form-group">
                    <label style={{marginTop:'2%'}}> 내용 </label>
                    <textarea placeholder="내용을 입력해주세요플레" 
